...
public class OrderController {
    ...
    @GetMapping("/sorted")
    public ResponseEntity<PaginationResponse<OrderDTO>> getAllOrdersSorted(
        ...
        PaginationResponse<OrderDTO> response = orderService.getAllOrdersSorted(sort, page, pageSize);
